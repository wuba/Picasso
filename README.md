...
[Picasso](https://github.com/wuba/Picasso/releases/download/v2.1.1/picasso.sketchplugin.zip)是58同城推出的一款sketch设计稿解析插件，可将sketch设计稿自动解析成还原精准，可用度高的前端代码。
...
[下载picasso插件](https://github.com/wuba/Picasso/releases/download/v2.1.1/picasso.sketchplugin.zip) => picasso.sketchplugin.zip 解压压缩包，双击安装即可，如下：
