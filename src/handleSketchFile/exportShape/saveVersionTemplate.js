...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  Document.open(sketchPath, function (err, document) {
    if (err) {
      ...
      try {
        function tree(){
          var documentData = document.sketchObject.documentData();
          var foreignSymbolList = documentData.foreignSymbols();
          for (var i = 0; i < foreignSymbolList.length; i++) {
            foreignSymbolList[i].unlinkFromRemote();
          }
